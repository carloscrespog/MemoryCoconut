...
public class NoteEdit extends Activity {
		...
		confirmButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if((mTitleText.getText().toString()).equals("") || (mTitleText.getText().toString()).equals(" ")  ||
					...
					showErrorMessage("Error", "Email inválido");
				}else{
	...
	private void saveState() {
		...
		if((mTitleText.getText().toString()).equals("") || (mTitleText.getText().toString()).equals(" ")  ||
				(mBodyText.getText().toString()).equals("") || (mBodyText.getText().toString()).equals(" ") ||
				(mEmailText.getText().toString()).equals("") || (mEmailText.getText().toString()).equals(" ") ){
			Toast.makeText(getBaseContext(), "Recocordatorio no guardado: campos incompletos",Toast.LENGTH_LONG).show();
		}else if(!isEmailValid(mEmailText.getText().toString())){
			Toast.makeText(getBaseContext(), "Recocordatorio no actualizado: email inválido",Toast.LENGTH_LONG).show();
